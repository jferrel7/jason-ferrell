  ...
  return (
    <main className="flex min-h-screen flex-col p-16">
      ...
      <p className="max-w-xl mb-12 text-gray-400">
        Building a knowledge portal for company intranets, with an integrated block editor for creating structured content with curated enterprise video/image/learning/files media.
      </p>
      <ul className="mb-12">
